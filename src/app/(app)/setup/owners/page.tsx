                ...
                <TR key={o.id}>
                  ...
                  <TD>
                    {canEdit ? <div className="flex justify-end gap-2">
                      {o.phone && (
                        <a
                          href={`https://wa.me/${o.phone.replace(/[^0-9]/g, '').startsWith('0') ? '212' + o.phone.replace(/[^0-9]/g, '').substring(1) : o.phone.replace(/[^0-9]/g, '')}?text=${encodeURIComponent(`Bonjour ${o.firstName || ''} ${o.name}, c'est le Syndic. Un petit rappel concernant vos cotisations. Vous pouvez consulter votre état de compte sur la plateforme. Merci !`)}`}
                          target="_blank"
